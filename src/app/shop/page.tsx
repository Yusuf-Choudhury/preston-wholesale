...
import LogisticsTruck from "../../components/LogisticsTruck"; // The truck animation
...
const FEATURED_PRODUCTS = [
  {
    ...
    category: "Energy",
    image: "https://images.unsplash.com/photo-1613216073612-9c4c11488c5a?q=80&w=800&auto=format&fit=crop", // Dark Can
  },
  {
    id: 2,
    name: "Glacier Spring Source",
    category: "Hydration",
    image: "https://images.unsplash.com/photo-1548839140-29a749e1cf4d?q=80&w=800&auto=format&fit=crop", // Water Bottle
  },
  {
    id: 3,
    name: "Amber Reserve",
    category: "Spirits",
    image: "https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?q=80&w=800&auto=format&fit=crop", // Whiskey/Drink
  },
];
...
export default function ShopPage() {
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-white pt-24 pb-20">
      ...
      {/* 3. FEATURED GRID (Large Cards like the Image) */}
      ...
      {/* 4. LATEST ARRIVALS (Horizontal List like the Image) */}
